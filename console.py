...
<div id='container'><iframe id='Frame2' scrolling='no' src='/static/point_cloud_layer.html' frameborder='0'></iframe></div>
    ...
    p = subprocess.Popen('sudo python3 /home/jay/Documents/unitree-lidar/WorkingUnilidar/unilidar_subcriber_udp.py '+str(number), shell=True, stdout=subprocess.PIPE, stderr=STDOUT)
    while True:
